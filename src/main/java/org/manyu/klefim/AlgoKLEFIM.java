...
public class AlgoKLEFIM {
     ...
     */
    public Itemsets runAlgorithm(int k,int minUtil, int minLen, int maxLen, String inputPath, String outputPath, boolean activateTransactionMerging, int maximumTransactionCount, boolean activateSubtreeUtilityPruning) throws IOException {
...
//		        }
	        ...
	        if(utilityPe  >= minUtil && prefixLength+1>=minLen)
	        {
	        	// output PU{e}
